    ...
    return (
        ...
        <div className="p-6 bg-gray-100 min-h-screen dark:bg-gray-900">
            ...
            <input
                ...
                className="w-full p-2 mb-4 border border-gray-300 rounded-lg text-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
            />
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Card de Saldo Total */}
                <motion.div className="bg-white p-4 rounded-xl shadow-md dark:bg-gray-800">
                    <h2 className="text-lg font-semibold text-gray-700 dark:text-white">Saldo Total</h2>
                ...
                <motion.div className="bg-white p-4 rounded-xl shadow-md col-span-2 dark:bg-gray-800">
                    <h2 className="text-lg font-semibold text-gray-700 dark:text-white">Últimas Transações</h2>
