        ...
        <div className="flex items-center gap-6">
          ...
          {user && (
            <nav className="hidden md:flex gap-6 text-sm">
              <Link href="/dashboard" className="hover:text-blue-500 transition-colors dark:text-gray-300">
                Dashboard
              </Link>
              <Link href="/dashboard/charts" className="hover:text-blue-500 transition-colors dark:text-gray-300">
                Gráficos
              </Link>
            </nav>
          )}
      ...
      >
        <div className="px-4 py-4 flex flex-col gap-4">
          ...
          {!user && (
            <Link
              href="/login"
              className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-xl text-white text-center transition-colors"
            >
              Login
            </Link>
          )}
